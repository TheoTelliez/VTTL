...
function actionVTTInscription($twig, $db) {
    ...
    $listeroles = $role->select();
    $form['roles'] = $listeroles;
...
AAACEEEEIIIIOOOOOUUUUYaaaaaaceeeeiiiioooooouuuuyy');
        ...
        if ($inputPassword != $inputPassword2) {
            ...
            if ($unUtilisateur == null) {
                if ($unUtilisateur != null) {
                    $form['valide'] = false;
                    $form['message'] = 'Utilisateur déja inscrit sur le site VTT Learning';
                } else {
                    ...
                    // Sujet
                    $subject = 'Validation de votre inscription sur VTT Learning';
...
//                $headers[] = 'To: Mary <mary@example.com>, Kelly <kelly@example.com>';
                    $headers[] = 'From: VTTL <validation@vttl.com>';
...
//                    $exec = $utilisateur->updaterecup($datevalide, $numvalide, $inputEmail);
                ...
                $form['valide'] = false;
                $form['message'] = 'Utilisateur non inscrit sur le site VTT Learning';
            }
