    ...
    if (isset($_POST['btOublie'])) {
        ...
        if ($unUtilisateur != null) {
            if ($unUtilisateur == null) {
                ...
                header("Location:index.php?page=checkmail");
...
//                $headers[] = 'To: Mary <mary@example.com>, Kelly <kelly@example.com>';
                $headers[] = 'From: VTTL <recuperation@vttl.com>';
    ...
    echo $twig->render('mdpoublievttl.html.twig', array('form' => $form));
}

function actionCheckMail($twig, $db) {
    echo $twig->render('checkmailvttl.html.twig', array());
}
...
function actionModifMotDePasse($twig, $db) {
    ...
    echo $twig->render('modifmotdepassevttl.html.twig', array('form' => $form));
}
