...
class Graphique {
    ...
    public function __construct($db) {
        $this->db = $db;
        $this->selectCountCo = $db->prepare("SELECT t1.email, (SELECT COUNT(*) FROM connexions t2 WHERE t2.emailco = t1.email) as nombredeco FROM utilisateurvttl t1 ORDER by nombredeco desc");
    ...
    public function top($dataly, $type) {
        ...
        if ($type == 'barres3') {
            $axe = array('0h', '1h', '2h', '3h', '4h', '5h', '6h', '7h', '8h', '9h', '10h', '11h', '12h', '13h', '14h', '15h', '16h', '17h', '18h', '19h', '20h', '21h', '22h', '23h', '24h');
